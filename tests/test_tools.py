...
def test_wolfram_alpha_tool_satisfies_tool_protocol():
    ...
    assert isinstance(tool, Tool), "WolframAlphaTool should satisfy the Tool protocol."
        ...
        (
            {
                "queryresult": {
                    ...
                    "pods": [
                        {
                            "title": "Result",
                            "subpods": [{"plaintext": "Mocked Wolfram Alpha response"}],
                        }
                    ],
                }
            },
...
def test_wolfram_alpha_tool_to_groq_spec():
    ...
    assert spec["required"] == ["query"], "The required field should contain 'query'."
