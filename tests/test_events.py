...
class TestSignal(unittest.TestCase):
    ...
    def test_signal_registration_and_emission(self):
    ...
    def test_signal_registration_and_emission_multiple_functions(self):
    ...
    def test_signal_missing_functions(self):
...
class TestViewEvents(unittest.TestCase):
    ...
    def test_view_events_initialization(self):
    ...
    def test_view_events_on_user_input_signal(self):
        ...
        view_events.on_user_input.emit(event_data)
